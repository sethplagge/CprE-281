...
// CREATED		"Thu Nov 13 15:15:12 2025"
...
assign	SYNTHESIZED_WIRE_2 = SYNTHESIZED_WIRE_14 ^ Q_ALTERA_SYNTHESIZED[1];

assign	SYNTHESIZED_WIRE_0 = Enable ^ Q_ALTERA_SYNTHESIZED[0];

assign	SYNTHESIZED_WIRE_7 = SYNTHESIZED_WIRE_15 ^ Q_ALTERA_SYNTHESIZED[2];
...
if (!SYNTHESIZED_WIRE_13)
	...
	begin
	Q_ALTERA_SYNTHESIZED[2] <= SYNTHESIZED_WIRE_7;
	end
end

assign	SYNTHESIZED_WIRE_10 = SYNTHESIZED_WIRE_15 & Q_ALTERA_SYNTHESIZED[2];

assign	SYNTHESIZED_WIRE_11 = SYNTHESIZED_WIRE_10 ^ Q_ALTERA_SYNTHESIZED[3];
